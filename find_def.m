...
grid on
hold on
% Цикл автоматического поиска точкек предплогаемого начала дефекта, по показаниям ...
...акселерометра на первом колесе 
% i=500;
% m=0;
...
% title('Совмещенные нормированные ускорения от отсчетов на участке с дефектом')
% xlabel('Отсчеты с частотой f, Гц')
